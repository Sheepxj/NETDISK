<template>
  <div class="login-wrap">
    <el-form :model="form" ref="formRef" class="login-container" :rules="rules">
      <h1 class="title">用户登录</h1>
      <el-form-item label="账号" prop="username">
        <el-input type="input" v-model="form.username" placeholder="输入账号" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item style="padding-left: 20%">
        <el-button type="primary" style="width: 40%;" @click="handleLogin()">登录</el-button>
        <el-button type="info" style="width: 40%;" @click="pushSignUp">没有账号</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
    ...
    if (valid) {
      service.request({
        ...
        if (data.state == true) {
          ...
          window.localStorage["username"]=form.value.username
