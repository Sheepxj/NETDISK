  ...
  <div class="login-wrap">
    <el-form :model="form" ref="formRef" class="login-container" :rules="rules" >
      ...
      <el-form-item label="账号" prop="username">
        <el-input type="input" v-model="form.username" placeholder="输入用户名" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item label="请确认密码" prop="password">
        <el-input type="password" v-model="form.password" placeholder="再次输入密码" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" style="width: 100%;" @click="handleSignUp()">注册</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
